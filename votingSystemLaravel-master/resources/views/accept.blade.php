...
<head>
  ...
  <title>Commissioner - candidate Selection</title>
        ...
        <div id="content">
          ...
          <div class="container-fluid" id="container-wrapper">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800">Accept or Reject</h1>
              <ol class="breadcrumb">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="container mt-2">
                        ...
                        <div class="pull-left">
                        <h2>These candidates are apply:</h2>
                        </div>
                        @if ($errors->any())
                    ...
                    @endif
                        ...
                        <form action="" method="Post">
                          ...
                          @if ($company->status==1)
                            ...
                            <a class=" btn btn-primary" style="pointer-events: none; display: inline-block; opacity: 0.5;" href="/final/{{ $company->email }}" >Add</a>
    
        
                                 @else
    
                                 <a class="btn btn-primary" href="/final/{{ $company->email }}">Add</a>
       
                             @endif
                        
                        @csrf
                        <a class="btn btn-danger" href="/finalDelete/{{ $company->email }}">Delete</a>
