        ...
        <li class="nav-item">
          ...
          <div id="collapsePage" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="/expire">Time</a>
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 margin-tb">
                            ...
                            <div class="pull-left">
                                ...
                                <h2>Total Get Votes of Candidate</h2>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <form action="/voteComplete" method="GET">
                
                            <td><input type="radio" id="html" name="html" value="{{ $product->candidateMail }}"></td>
